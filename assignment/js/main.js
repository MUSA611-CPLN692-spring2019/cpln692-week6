...
//var dataURL = "https://raw.githubusercontent.com/CPLN690-MUSA610/datasets/master/json/philadelphia-solar-installations.json";
  // solar installations - x,y
//var dataURL2 = "https://raw.githubusercontent.com/CPLN690-MUSA610/datasets/master/json/philadelphia-bike-crashes-snippet.json";
  //philly bike crashes - latitude, longitude

  var dataURL = "https://raw.githubusercontent.com/CPLN690-MUSA610/datasets/master/json/philadelphia-solar-installations.json";
  // $('#text-input1').val(dataURL);
  // $('#text-input2').val("Y");
  // $('#text-input3').val("X");
  //
  // var lat_key = $('#text-input2').val();
  // var lng_key = $('#text-input3').val();
  ...
  //
  // $('#text-input1').val(dataURL);
  // $('#text-input2').val(lat_key);
  // $('#text-input3').val(lng_key);
...
var makeMarkers = function(parsed) {
    var makeMarker = (i) => {
      console.log(i);
      return L.marker([i[$('#text-input2').val()],i[$('#text-input3').val()]]);
    };
    var allMarkers = _.map(parsed, makeMarker);
...
var plotMarkers = function(markers) {
  ...
  console.log("markers plotted");
  return plottedMarkers;
};

//$('#text-input1').val();
//$('button').click(console.log('abcd'));
...
$("#rs_button").click(function () {
      $.ajax($('#text-input1').val()).done(function(data) {
                  ...
                  pastMarkers = makeMarkers(parsed);
                  plotMarkers(pastMarkers);
                });
});
